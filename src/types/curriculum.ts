...
export interface Subject {
  id: string;
  code: string;           // รหัสวิชา e.g. 'T1001'
  name: string;           // ชื่อวิชา e.g. 'คณิตศาสตร์'
...
export interface CurriculumMap {
  id: string;
  name: string;          // ชื่อหลักสูตร e.g. 'หลักสูตรวิทยาศาสตร์', 'หลักสูตรศิลป์'
  gradeLevel: string;    // 'ป.1', 'ม.3', etc.
  department: Department;
  semester: 1 | 2;
