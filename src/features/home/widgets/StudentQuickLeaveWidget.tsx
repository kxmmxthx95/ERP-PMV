...
import { useMyLeaveRequests, countDays } from '@/hooks/useLeaveRequests';
...
export default function StudentQuickLeaveWidget() {
  ...
  return (
    <motion.div
      ...
      style={WIDGET_GLASS}
      className={`rounded-3xl p-5 flex flex-col relative overflow-hidden group transition-all duration-500 w-full ${
        view === 'summary' ? 'min-h-[110px] justify-center' : 'min-h-[240px]'
      }`}
    >
          ...
          >
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <motion.button
                ...
                className="w-14 h-14 rounded-full bg-rose-500 text-white flex items-center justify-center hover:bg-rose-600 transition-all group/btn"
              >
        ...
        {view === 'form' && (
          ...
          >
            ...
            <button
              ...
              disabled={submitting || !reason.trim() || !startDate || !endDate}
