...
import {
  ...
  Menu, LogOut, Network, BookOpen, TableProperties, FileText,
} from 'lucide-react';
  ...
  sysadmin: {
    ...
    sections: [{
      items: [
        ...
        { name: 'ทำเนียบนักเรียน', path: '/sysadmin/students',   icon: 'group' },
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col py-2 px-2 flex-shrink-0 gap-0.5">
        {/* Settings */}
        {[
          { icon: 'flag', label: 'รายงานปัญหา', onClick: undefined },
          { icon: 'help', label: 'ช่วยเหลือ', onClick: undefined },
          { icon: 'settings', label: 'ตั้งค่า', onClick: () => handleNav(`/${activeRole}/settings`) },
